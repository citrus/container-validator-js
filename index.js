...
;(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory()
    : typeof define === 'function' && define.amd ? define(factory)
      : global.ContainerValidator = factory()
}(this, function () {
  'use strict'
  ...
  return function () {
    ...
    this.generate = function (ownerCode, productGroupCode, from, to) {
      ...
      var alphabetCode = this.strtoupper(ownerCode + productGroupCode)
      var containers_no = []

      if (this.is_string(alphabetCode) && this.strlen(ownerCode) === 3 && this.strlen(productGroupCode) === 1) {
        containers_no = []
        var current_container_no = ''
        var current_container_check_digit = ''
    ...
    this.createCheckDigit = function (containerNumber) {
      var checkDigit = -1
      if (!this.empty(containerNumber) && this.is_string(containerNumber)) {
        var matches = this.identify(containerNumber, true)
